...
public class CountryAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        int flag_resource_id = GetDrawableIDByName(con,Name[i].toLowerCase(Locale.ENGLISH));
        CountryImage.setImageResource(flag_resource_id);

        return MyView;
    }

    private int GetDrawableIDByName(Context con, String ImgName) {

        return con.getResources().getIdentifier(ImgName, "drawable",con.getPackageName());
    }
}